 ...
 */
final class Version20230201100209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE film_show_taken_seat (id INT NOT NULL, film_show_id INT DEFAULT NULL, line INT NOT NULL, seat INT NOT NULL, reservation_number BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', UNIQUE INDEX UNIQ_8345C464DE6156CF (reservation_number), INDEX IDX_8345C464307FE747 (film_show_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
